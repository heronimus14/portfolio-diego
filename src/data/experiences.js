...
export const experiencesData = [
  {
    ...
    description: "Tampil sebagai anggota paduan suara dalam acara pernikahan dengan fokus pada kekompakan, disiplin, dan performa profesional.",
