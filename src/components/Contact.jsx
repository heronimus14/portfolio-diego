...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 px-6 max-w-4xl mx-auto relative z-10 w-full scroll-mt-20">
      <motion.div
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 mb-8">
          <motion.a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-6 py-3.5 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-full font-semibold flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:shadow-[0_0_30px_rgba(34,197,94,0.5)] transition-shadow"
          >
